...
func GetNnumbersTotalCases(n, total int) [][]int {
	...
	// case : {total - 1 , 나머지 case[1:]에서 n-1개의 숫자의 합이 1을 이루는 경우1}, {total-1, ~경우2}, {total-1, ~경우3}, ...
	// case : {total - 2 , 나머지 case[1:]에서 n-1개의 숫자의 합이 2를 이루는 경우1}, {total-2, ~경우2}, {total-2, ~ 경우3}, ...
	// ...
	// case : {0, 나머지 case[1:]에서 n-1개의 숫자의 합이 total을 이루는 경우1}, {0, ~경우2}, {0, ~경우3}, ...
